...
const CreateCampaign = () => {
  ...
  const { CreateCampaign:createCampaign } = useStateContext();
    ...
    checkIfImage(form.image, async(exists)=>{
        if(exists){
          ...
          await createCampaign({
            ...form, target: ethers.utils.parseUnits(
              form.target, 18)})
            setIsLoading(false);
            navigate('/');
            }else{
  ...
  return (
    ...
    '>
      ...
      <div className='flex justify-center items-center p-[16px] sm:min-w-[380px] bg-[#3a3a43] rounded-[10px]'>
        <h1 className='font-epilogue font-bold sm:text-ellipsis [25px] text-[18px] leading-[38px] text-white'>
          Start a Campaign</h1>
      </div>
      ...
      >
        ...
        <FormField 
          ...
          items-center p-4 bg-[#8c6dfd] h-[120px]
          rounded-[10px]
          '>
